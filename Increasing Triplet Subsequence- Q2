...
/*Explanation:
  ...
  if the current number is smaller than the first number then change the first number to that number,
  next if the current number is greater than the first numbers but smaller the second number, then update the
  second number. Now if the current number is greater than both the first and the second then
